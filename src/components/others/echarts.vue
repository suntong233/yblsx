  ...
  <div class="echarts-container">
      <el-tabs v-model="activeName">
        <el-tab-pane label="入门示例" name="first">
          ...
          <h3>
            该企业注册资本185000万元人民币(元)，属于科技推广和应用服务业。注册资金方面,在全国同行企业中，表现优秀。
          </h3>
          <div ref="ecahrtbox2" class="ecahrtbox1"></div>
          <h3>
            全国范围内,同业资金集中在5000万以上和1000- 5000万规模的企业中,共115315家,注册资本合计746345381.09万元，占比73.44%.
          </h3>
      ...
      myChart2.setOption({
          ...
          series: [{
                ...
                detail: { // 仪表盘详情，用于显示数据。
                    ...
                    offsetCenter: [0,
                    "30%"], // 相对于仪表盘中心的偏移位置，数组第一项是水平方向的偏移，第二项是垂直方向的偏移。可以是绝对的数值，也可以是相对于仪表盘半径的百分比。
    ...
    series : [
        {
            ...
            data:[
                ...
                {value:26996.2415, name: '100-1000万',
                label:{
                        formatter:"23.41%"
                    },
                    itemStyle:{
                ...
                {value:27433.4385, name: '1000-5000万',
                label:{
                        formatter:"23.79%"
                    },
                    itemStyle:{
